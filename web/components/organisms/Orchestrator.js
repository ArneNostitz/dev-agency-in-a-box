// Organism — Orchestrator. Extracted from web/orch.js; logic unchanged.
// The conversational front door: chat with an agent that knows the repo; when an idea is ready it
// proposes scoped work you confirm into PLANNED, by-agent issues. statusField now comes from the
// new ProgressTable organism.
...
import { statusField } from "./ProgressTable.js";
