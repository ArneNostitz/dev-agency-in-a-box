...
const ROLE_AVATAR = { planner: "planner-f", plan: "planner-f", decomposer: "auditor", architect: "architect", arch: "architect", developer: "developer-f", dev: "developer-f", coder: "developer-f", reviewer: "reviewer", review: "reviewer", tester: "tester", test: "tester", librarian: "librarian-f", auditor: "auditor", analyzer: "auditor" };
const ROLE_WORDS = ["planner", "decomposer", "architect", "developer", "reviewer", "tester", "librarian", "auditor", "analyzer"];
...
const ROLE_EMOJI = { planner: "🧠", architect: "🏛", developer: "💻", reviewer: "🔍", tester: "🧪", librarian: "📚", auditor: "🔎", analyzer: "🔬" };
const ROLE_ICON = { planner: "layers", decomposer: "layers", developer: "laptop", reviewer: "flask", tester: "flask", architect: "settings", librarian: "history", analyzer: "flask" };
