...
// Searchable provider picker (combobox) for the Add-provider form. Type to filter, ↑/↓ to move,
// Enter to pick, click to select. `options` = [{id, label, logo?}] (logo = provider name for the
// logo lookup). `value` is the selected option id; onChange(id) fires on pick ("" clears).
