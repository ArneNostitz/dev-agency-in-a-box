// Dev Agency — atomic, reusable UI components (atomic design). Single source of truth for small
// presentational primitives reused across the app (header, list rows, board cards, …).
